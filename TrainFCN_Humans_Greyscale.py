...
tf.flags.DEFINE_string("data_dir", EnvVars.data_dir + "/Humans", "path to dataset")
...
def main(argv=None):
  segment = FCN.Segment(True, 224, 224, 1, 1, False)
  segment.init_network(False)

  segment.visualize_directory(
    segment.train_dataset_reader, False, False,
    EnvVars.data_dir + "/Humans/data/images/training",
    EnvVars.data_dir + "/Human/data/ouptput_grey")
